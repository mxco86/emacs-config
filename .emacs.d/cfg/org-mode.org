...
*** Org-Agenda
    ...
    (setq org-agenda-files '("~/Org/Documents/org-moj/meeting-notes/"))
    (setq org-archive-location "~/Org/Documents/org-moj/task-archive.org::* From %s ")
...
*** Org-Id
    ...
    (setq org-id-extra-files
          (append (directory-files-recursively "~/Org/Documents/notebooks" ".*")
                  (directory-files-recursively "~/Org/Documents/org-moj" ".*")))
    #+end_src
*** Presentation
    #+begin_src emacs-lisp
