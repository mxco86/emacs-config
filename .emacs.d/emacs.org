...
*** Emacs Package Management
    Paradox enhances the package list with some extra bits, including GitHub
    stars and a link to the package home page, which gives some indication of
    rating and more detailed info
    #+begin_src emacs-lisp
